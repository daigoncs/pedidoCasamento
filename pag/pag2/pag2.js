export default () => {
    ...
    const templatePagTwo = `
            <section id="page2" class="page" aria-label="Galeria">
                ...
                <figure class="polaroid p2"><img src="img/7.JPG" alt="Polaroid 2"><figcaption>Que fala bastante, expressa tudo o que sente, que dança e que ri alto</figcaption></figure>
